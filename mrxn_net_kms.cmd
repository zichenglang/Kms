chcp 936
@echo off&PUSHD  &TITLE Lacdon_Windows_Office激活工具
...
:start
set KMS_Sev=kms.lacdon.com
cls
echo VL版本系列windows和office激活脚本;
echo 希望可以多多支持我的小店 shop.lacdon.com;
echo.
ping kms.lacdon.com | find "超时"  > NUL &&  goto fail
ping kms.lacdon.com | find "目标主机"  > NUL &&  goto fail
echo 成功连接上服务器……
...
if defined %EditionID% (
	...
	cscript //Nologo %windir%\system32\slmgr.vbs /skms kms.lacdon.com
...
if DEFINED _Office%1Path (
    ...
    cscript //nologo ospp.vbs /sethst:kms.lacdon.com >nul
